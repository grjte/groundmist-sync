...
docker build -t ghcr.io/groundmist/groundmist-sync:$VERSION -t ghcr.io/groundmist/groundmist-sync:latest .

# Push the Docker image
docker push ghcr.io/groundmist/groundmist-sync:$VERSION
docker push ghcr.io/groundmist/groundmist-sync:latest
